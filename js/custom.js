(function()
{
    ...
    let magnificPopupControl = function()
    {
        ...
        $('.with-caption').magnificPopup({
                                             ...
                                             image              : {
                                                 ...
                                                 {
                                                     return item.el.attr(
                                                         'title') + ' &middot; <a class="image-source-link" href="' + item.el.attr(
